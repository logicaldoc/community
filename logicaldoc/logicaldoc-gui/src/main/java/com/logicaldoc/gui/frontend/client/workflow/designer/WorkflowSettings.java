...
public class WorkflowSettings extends Window {
	...
	public WorkflowSettings(GUIWorkflow workflow) {
		...
		StaticTextItem version = ItemFactory.newStaticTextItem("version", "version", "" + this.workflow.getVersion());
		...
		form.setItems(workflowName, version, id, workflowDescr, supervisors, save);
		setMembers(form);
