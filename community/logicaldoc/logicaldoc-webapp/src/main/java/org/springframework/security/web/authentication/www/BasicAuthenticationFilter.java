...
public class BasicAuthenticationFilter extends OncePerRequestFilter {
	 ...
	 *
	 * @param authenticationManager the bean to submit authentication requests
	 *        to
	 */
	 ...
	 * @param authenticationManager the bean to submit authentication requests
	 *        to
	 * @param authenticationEntryPoint will be invoked when authentication
	 *        fails. Typically an instance of
	...
	private String[] extractAndDecodeHeaderAll(String header, HttpServletRequest request) throws IOException {
		...
		return new String[] { decoded.substring(0, delim), decoded.substring(delim + 1) };
	}
