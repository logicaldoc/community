...
public class WSRight {
	...
	@WSDoc(description = "permissions mask. "
			...
			+ "<ol><li>Password</li><li>Print</li><li>Subscription</li><li>Calendar</li><li>Workflow</li><li>Archive</li><li>Sign</li><li>Export</li><li>Import</li>"
			...
			+ "</p><p>A) if you want to assign to a user the permissions Read, Write, Immutable, Rename, Sign, Download, the 'permissions' value must be <b>2215</b>, in fact it is <b>00000100010100111</b> in binary representation."
			+ "</p><p>B) if you want to assign to a group the permissions Read, Write, Add, Security, Import, Archive, Workflow, the 'permissions' value must be <b>6421</b>, in fact it is <b>00001100100010101</b> in binary representation."
			+ "</p><p><br></p>")
