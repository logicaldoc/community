...
public class RestTagClient extends AbstractRestClient {
	...
	public void addDocumentTags(long docId, String[] tags) throws Exception {
	...
	public void setDocumentTags(long docId, String[] tags) throws Exception {
		WebClient.client(proxy).type(MediaType.APPLICATION_FORM_URLENCODED);
		WebClient.client(proxy).accept(MediaType.APPLICATION_JSON);
		proxy.setDocumentTags(docId, tags);
	}

	public void addFolderTags(long folderId, String[] tags) throws Exception {
		WebClient.client(proxy).type(MediaType.APPLICATION_FORM_URLENCODED);
		WebClient.client(proxy).accept(MediaType.APPLICATION_JSON);
		proxy.addFolderTags(folderId, tags);
	}

	public void setFolderTags(long folderId, String[] tags) throws Exception {
		WebClient.client(proxy).type(MediaType.APPLICATION_FORM_URLENCODED);
		WebClient.client(proxy).accept(MediaType.APPLICATION_JSON);
		proxy.setFolderTags(folderId, tags);
	}

	public String[] getDocumentTags(long docId) throws Exception {
	...
	public WSDocument[] findDocumentsByTag(String tag) throws Exception {
		WebClient.client(proxy).type(MediaType.APPLICATION_JSON);
		WebClient.client(proxy).accept(MediaType.APPLICATION_JSON);
		return proxy.findDocumentsByTag(tag);
	}

	public WSFolder[] findFoldersByTag(String tag) throws Exception {
		WebClient.client(proxy).type(MediaType.APPLICATION_JSON);
		WebClient.client(proxy).accept(MediaType.APPLICATION_JSON);
