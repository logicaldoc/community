...
public class TypeManager {
    ...
    private static void addDocumentPropertyDefinitions(DocumentTypeDefinitionImpl type) throws PersistenceException {
        ...
        for (AttributeSet set : dao.initialize(dao.findAll())) {
    ...
    private static PropertyDefinition<?> createPropDef(
        ...
        AbstractPropertyDefinition<?> result = switch (datatype) {
            ...
            case STRING -> new PropertyStringDefinitionImpl();
            case URI -> new PropertyUriDefinitionImpl();
            default -> throw new IllegalArgumentException("Unknown datatype! Spec change?");
        };
