...
public class LDRepositoryTest extends AbstractCmisTestCase {
    ...
    public void testCancelCheckOut() throws PersistenceException {
        ...
        testSubject.cancelCheckOut("doc.%d".formatted(document.getId()));
    ...
    public void testGetObjectByPath() throws PersistenceException {
        ...
        String path = "%s/%s".formatted(fdao.computePathExtended(folder), doc.getFileName());
    ...
    public void testMoveObject() throws PersistenceException {
        ...
        Folder folder6 = fdao.findById(6L, true);
    ...
    public void testAppendContent() throws PersistenceException, IOException {
        ...
        try (FileInputStream fis = new FileInputStream(content)) {
            ContentStream contentStream = new ContentStreamImpl("file.txt",
                    new BigInteger(Long.toString(content.length())), "text/plain; fileNameCharset=UTF-8", fis);
