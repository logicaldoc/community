...
public class SampleClient {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("%s %s".formatted(object.getId(), object.getName()));
    ...
    static void checkoutCheckin() throws IOException {
        ...
        object = session.getObjectByPath("%s/%s".formatted(TEST_FOLDER_PATH, TEST_DOCUMENT_NAME_1));
        System.out.println("%s %s".formatted(object.getId(), object.getProperty(PropertyIds.NAME).getValues().get(0)));
    ...
    static void listFolder(int depth, Folder target) {
        ...
        for (Iterator<CmisObject> it = target.getChildren().iterator(); it.hasNext();) {
            ...
            if (BaseTypeId.CMIS_DOCUMENT.equals(o.getBaseTypeId())) {
                System.out.println("%s[Docment] %s".formatted(indent, o.getName()));
            } else if (BaseTypeId.CMIS_FOLDER.equals(o.getBaseTypeId())) {
                System.out.println("%s[Folder] %s".formatted(indent, o.getName()));
    ...
    static void deleteDocument(Folder target, String delDocName) {
        try {
            ...
            System.err.println("Document is not found: %s".formatted(delDocName));
        }
    }
    ...
    static void createDocument(Folder target, String newDocName) {
        ...
        System.out.println("This is a test document: %s".formatted(newDocName));
