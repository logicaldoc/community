...
public class MessageTemplatesPanel extends VLayout {
    ...
    public void onDraw() {
        ...
        langSelector.addChangedHandler(changed -> reload());

        ToolStripButton add = new ToolStripButton();
        add.setAutoFit(true);
        add.setTitle(I18N.message("addmessagetemplate"));
        add.addClickHandler(click -> {
        ...
        save.addClickHandler(click -> saveTemplates());
    ...
    private void saveTemplates() {
        ...
        for (Record rec : records) {
            ...
            template.setFooter(rec.getAttributeAsString("footer"));
            template.setButtons(rec.getAttributeAsString("buttons"));
    ...
    private void showContextMenu() {
        ...
        delete.setEnabled("USER".equals(list.getSelectedRecord().getAttributeAsString("type")));
