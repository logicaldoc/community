...
import com.logicaldoc.gui.frontend.client.document.summary.SummaryDialog;
...
public class ContextMenu extends Menu {
    ...
    protected void fillContextMenu(
            GUIFolder folder,
            final List<GUIDocument> selection,
        ...
        setItems(download, preview, summary, openInFolder, cut, copy, rename, bookmark, sendMail, links, office,
    ...
    private void applySecurityPolicies(
            GUIAccessControlEntry allowedPermissions,
            final List<GUIDocument> selection,
    ...
    private void applySplitSecurity(
            GUIAccessControlEntry enabledPermissions,
            List<GUIDocument> selection,
            boolean moreSelected,
            boolean justOneSelected) {
    ...
    private void applyOfficeSecurity(
            GUIAccessControlEntry enabledPermissions,
            List<GUIDocument> selection,
            boolean justOneSelected) {
    ...
    private void applyDownloadSecurity(
            GUIAccessControlEntry enabledPermissions,
            boolean someSelection,
            boolean justOneSelected) {
    ...
    private void applyLockingSecurity(
            GUIAccessControlEntry enabledPermissions,
            List<GUIDocument> selection,
            boolean someSelection,
            boolean immutablesInSelection,
    ...
    private void applyIndexableSecurity(
            GUIAccessControlEntry enabledPermissions,
            List<GUIDocument> selection,
            boolean someSelection,
            boolean immutablesInSelection) {
    ...
    private void applyEmbeddingSecurity(
            GUIAccessControlEntry enabledPermissions,
            List<GUIDocument> selection,
            boolean someSelection,
            boolean immutablesInSelection) {
    ...
    private void applyPasswordSecurity(
            GUIAccessControlEntry enabledPermissions,
            List<GUIDocument> selection,
            boolean justOneSelected,
            boolean immutablesInSelection) {
    ...
    private void applySignSecurity(
            GUIAccessControlEntry enabledPermissions,
            List<GUIDocument> selection,
            boolean someSelection,
            boolean immutablesInSelection) {
