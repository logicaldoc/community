...
public class DocumentFieldsDS extends DataSource {
    ...
    public DocumentFieldsDS(GUITemplate template) {
        ...
        DataSourceIntegerField signed = new DataSourceIntegerField("signed", I18N.message("signed"));
        signed.setValidOperators(OperatorId.EQUALS, OperatorId.NOT_EQUAL);
        ...
        setFields(id, filename, fileSize, pages, publisher, version, revision, lastModified, published, created,
                creator, customId, extension, rating, tags, comment, notes, wfStatus, publishedStatus, startPublishing,
                stopPublishing, indexed, signed, tmplt);
