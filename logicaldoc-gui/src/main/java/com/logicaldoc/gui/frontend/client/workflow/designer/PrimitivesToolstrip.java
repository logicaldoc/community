...
public class PrimitivesToolstrip extends ToolStrip {
	...
	public PrimitivesToolstrip(WorkflowDesigner designer) {
		...
		newTask.addClickHandler(event -> workflowDesigner.onAddState(GUIWFState.TYPE_TASK));
		addButton(newTask);
		addSeparator();
		...
		newEndState.addClickHandler(event -> workflowDesigner.onAddState(GUIWFState.TYPE_END));
		...
		newFork.addClickHandler(event -> workflowDesigner.onAddState(GUIWFState.TYPE_FORK));
		addButton(newFork);
		addSeparator();
		...
		newJoin.addClickHandler(event -> workflowDesigner.onAddState(GUIWFState.TYPE_JOIN));
		addButton(newJoin);
