...
public class SystemMenu extends VLayout {
    ...
    private void addInformations() {
        ...
        installationID.setIcons(new CopyTextFormItemIcon(installationId));

        final CopyTextFormItemIcon copyUserNo = new CopyTextFormItemIcon(userno);
        copyUserNo.setDisabled(true);
        ...
        usernoItem.setIcons(new CopyTextFormItemIcon(userno));
