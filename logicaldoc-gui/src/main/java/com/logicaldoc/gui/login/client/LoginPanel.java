                            ...
                            if (trusted.booleanValue()) {
                                ...
                                SC.ask(I18N.message("trustdevice"), I18N.message("trustdevicequestion"), choice -> {
                                    if (Boolean.FALSE.equals(choice)) {
                                        ...
                                        LD.askForStringMandatory(I18N.message("trustdevice"),
                                                I18N.message("optlabeldevice"), null, value -> SecurityService.Instance
                                                        .get().trustDevice(value, new AsyncCallback<>() {
                                                ...
                                                click -> Util.redirectToSuccessUrl(language.getValueAsString()));
