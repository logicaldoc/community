...
public class GUIInfo implements Serializable {
    ...
    private String release = "9.3.1";

    private String year = "2006-2027";
    ...
    private boolean canUploadPackages = false;

    private GUIAttributeSet defaultAttributeSet;

    private GUIBranding branding = new GUIBranding();

    public boolean isCanUploadPackages() {
        return canUploadPackages;
    }

    public void setCanUploadPackages(boolean canUploadPackages) {
        this.canUploadPackages = canUploadPackages;
    }
