...
<script src="./pdf.mjs" type="module"></script>
    ...
    <script>
        ...
        window.addEventListener('load', function() {
          ...
          PDFViewerApplicationOptions.set("enableStampEditor", false);
          PDFViewerApplicationOptions.set("disablePreferences", true);
          PDFViewerApplicationOptions.set("annotationMode", pdfjsLib.AnnotationMode.DISABLE);
          PDFViewerApplicationOptions.set("sidebarViewOnLoad", false); 
