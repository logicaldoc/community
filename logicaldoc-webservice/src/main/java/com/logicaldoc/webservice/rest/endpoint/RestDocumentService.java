...
public class RestDocumentService extends SoapDocumentService implements DocumentService {
    ...
    public List<WSRating> getRatings(
            @QueryParam("docId")
            @Parameter(description = "Document ID", required = true)
            long docId) throws AuthenticationException, PermissionException, WebserviceException, PersistenceException,
            UnexistingResourceException {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public WSDocument move(
            @QueryParam("docId")
            @Parameter(description = "Document ID", required = true)
            long docId,
            @QueryParam("folderId")
            @Parameter(description = "Target Folder ID", required = true)
            long folderId) throws AuthenticationException, PermissionException, WebserviceException,
            PersistenceException, UnexistingResourceException {
        String sid = validateSessionREST();
        return super.move(sid, docId, folderId);
    }
    ...
    public WSDocument copy(
            ...
            boolean security) throws AuthenticationException, PermissionException, WebserviceException,
    ...
    public void promoteVersion(
            ...
            long docId,
            @QueryParam("version")
            String version) throws AuthenticationException, PermissionException, WebserviceException,
            PersistenceException, IOException, UnexistingResourceException {
        String sid = validateSessionREST();
    ...
    public List<WSDocument> getVersions(
            @QueryParam("docId")
            @Parameter(description = "Document ID", required = true)
            long docId) throws AuthenticationException, PermissionException, WebserviceException, PersistenceException,
            UnexistingResourceException {
    ...
    public String createDownloadTicket(
            ...
            @Parameter(description = "Optional password")
            String password)
    ...
    public void deleteLink(
            @Parameter(description = "ID of the link", required = true)
            @QueryParam("id")
    ...
    public List<WSDocument> getAliases(
    ...
    public WSDocument getDocumentByCustomId(
            @Parameter(description = "The custom ID", required = true)
            @QueryParam("customId")
            String customId)
            throws AuthenticationException, PermissionException, WebserviceException, PersistenceException {
        String sid = validateSessionREST();
    ...
    public List<WSDocument> getDocuments(
            @QueryParam("docIds")
    ...
    public List<WSDocument> getRecentDocuments(
            @QueryParam("maxHits")
    ...
    public DataHandler getResource(
            ...
            String suffix) throws AuthenticationException, PermissionException, WebserviceException,
            PersistenceException, IOException {
        String sid = validateSessionREST();
    ...
    public void setPassword(
            ...
            String password) throws AuthenticationException, PermissionException, WebserviceException,
            PersistenceException, UnexistingResourceException {
        String sid = validateSessionREST();
    ...
    public Response getThumbnail(
            @PathParam("type")
            @Parameter(description = "Type of thumbnail to generate (e.g., thumb, tile, mobile)", required = true)
            String type,
            @PathParam("docpath")
            @Parameter(description = "Path of the document. This parameter captures the full path using a greedy pattern and may include multiple nested folders.", required = true)
            String docPath) throws AuthenticationException, WebserviceException, PersistenceException, IOException,
            PermissionException {
        String sid = validateSessionREST();
    ...
    public boolean isGranted(
            @Parameter(description = "Document identifier (ID)", required = true)
            @QueryParam("docId")
            long docId,
            @Parameter(description = "the permissions' integer representation", required = true)
