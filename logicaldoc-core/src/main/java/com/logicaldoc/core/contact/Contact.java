...
public class Contact extends PersistentObject {
    ...
    public String getFullName() {
        return "%s%s".formatted(StringUtils.defaultString(firstName), StringUtils.defaultString(lastName));
    }
    ...
    public String toString() {
        return "%s%s".formatted(getFullName(), email != null ? " - %s".formatted(email) : "");
    }
