 ...
 */
@MappedSuperclass
public abstract class BasicHistory extends PersistentObject implements Comparable<BasicHistory> {

	public static final String ASPECT = "saveHistory";

	private static final long serialVersionUID = 1L;

	private static final Logger log = LoggerFactory.getLogger(BasicHistory.class);
	...
	protected void copyAttributesFrom(BasicHistory source) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BasicHistory other = (BasicHistory) obj;
		if (date == null) {
			if (other.date != null)
				return false;
		...
		for (BeanDefinition bd : scanner.findCandidateComponents("com.logicaldoc")) {
			...
			try {
				...
				if (annotation != null && StringUtils.isNotEmpty(annotation.name())
						&& BasicHistory.class.isAssignableFrom(beanClass))
