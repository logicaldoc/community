...
public interface DocumentDAO extends PersistentObjectDAO<Document> {
     ...
     * referenced document is returned instead. Lazy-loaded collections are not
     * initialized.
     * 
     ...
     *        initialized
     * 
     * @return Document with given ID or the referenced one
     * 
     * @throws PersistenceException an error happened in the database
     */
    ...
    /**
     * This method finds a document by the custom ID. Lazy-loaded collections
     * are not initialized.
     * 
    ...
    /**
     * Finds a document by it's full path. Lazy-loaded collections
     * are not initialized.
     * 
     * @param path The path comprehensive of the file name
     * @param tenantId The tenant
    ...
    /**
     * Retrieves, the workspace where the document(or alias) is stored in
     * 
