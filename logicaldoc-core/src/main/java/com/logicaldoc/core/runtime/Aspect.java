 ...
 */
public enum Aspect {
    AI, STORING, SENDINGMESSAGES, EVENTSGATHERING, SAVEHISTORY, INITIALIZATION, VALIDATION, CUSTOMID, UNIQUENESSFILENAME, WRITECHECK, SCHEDULEDTASKS, AUTOMATION, ANTIVIRUS, WORKSPACEQUOTACHECK, FORMPROCESSING, AUTONAMING, AUTOFOLDING, AUTOREVISIONING, SAVEAPICALL, WORKFLOW, AUTOFILL, UNIQUENESSCUSTOMID;
