...
public enum UserEvent {
	...
	LOGIN, LOGIN_FAILED, LOGOUT, TIMEOUT, PASSWORDCHANGED, TWOFACHANGED, DELETED, FILE_CONVERSION, MESSAGE_RECEIVED, CREATED, UPDATED, DISABLED, ENABLED, NEWAPIKEY, SEARCH, AI_QUERY, LEGAL_CONFIRMED, IMPERSONIFIERS_CHANGED;
