...
public class ExtendedAccessControlEntry extends AccessControlEntry {
    ...
    public String toString() {
        return String.format(
                "ExtendedAccessControlEntry [ace=%s, preview=%b, download=%b, security=%b, delete=%b, rename=%b, immutable=%b, sign=%b, archive=%b, workflow=%b, calendar=%b, subscription=%b, password=%b, print=%b, move=%b, email=%b, automation=%b, readingreq=%b, customid=%b, revision=%b]",
                ace, preview, download, security, delete, rename, immutable, sign, archive, workflow, calendar,
                subscription, password, print, move, email, automation, readingreq, customid, revision);
    }
