...
public class SecurityServiceImplTest extends AbstractWPTestCase {
    ...
    public void testSaveUser() throws ServerException {
        ...
        newUser.setExpire(DateUtils.addDays(referenceInstant, 30));

        GUIWorkingTime wt = new GUIWorkingTime("workl", referenceInstant, DateUtils.addHours(referenceInstant, 1));
