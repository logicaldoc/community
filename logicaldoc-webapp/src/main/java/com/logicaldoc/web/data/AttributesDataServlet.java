...
public class AttributesDataServlet extends AbstractDataServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response, Session session, Integer max,
        ...
        boolean extOnly = "true".equals(request.getParameter("extOnly"));
        ...
        for (Map.Entry<String, Attribute> entry : attributes.entrySet()) {
            ...
            String attributePrefix = extOnly ? "" : "ext_";
            printAttibute("%s%s".formatted(attributePrefix, entry.getKey()),
