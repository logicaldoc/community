...
public abstract class AbstractRemoteService extends RemoteServiceServlet {
    ...
    protected List<GUIAttribute> prepareGUIAttributes(Template template, ExtensibleObject extensibleObject) {
        try {
            if (template != null) {
                log.info(
                        "Preparing GUI attributes in {}: templateId={}, objectRecordVersion={}, extensibleObjectType={}, extensibleObjectId={}",
                        getClass().getSimpleName(), template.getId(), template.getRecordVersion(),
                        extensibleObject != null ? extensibleObject.getClass().getSimpleName() : null,
                        extensibleObject != null ? extensibleObject.getId() : null);
            }
    ...
    private GUIAttribute prepareGUIAttribute(
            String attrName,
            Template template,
