...
import static com.logicaldoc.onlyoffice.utils.Constants.MAX_FILE_SIZE;
...
public final class DocumentManager {
    ...
    */
    ...
    // get url to download a file
    public static String getDownloadUrl02(final String fileName, String docId, String sid, final Boolean forDocumentServer) {
        String serverPath = getServerUrl(forDocumentServer);
        String hostAddress = curUserHostAddress(null);
        try {
            String userAddress = forDocumentServer ? "&userAddress=" + URLEncoder
                    .encode(hostAddress, java.nio.charset.StandardCharsets.UTF_8.toString()) : "";
            String query = "?type=download&fileName=" + URLEncoder.encode(fileName, java.nio.charset.StandardCharsets.UTF_8.toString()) 
            + userAddress + "&docId=" +docId + "&sid=" +sid;
