...
public class TagUtil {
     ...
     * string containing all tags separated by a comma. <p> <b>Atention:</b> The
     * returned string is not more long than MAX_FIELD_LENGTH characters.
     * 
     * @param tenantName Name of the tenant
    ...
    public static String normalizeTags(String tenantName, String words) {
        ...
        String str = extractTags(tenantName, words).stream().map(t -> t.trim().replace(",", "\\,"))
