...
/**
 * <code>CharsetDetector</code> provides a facility for detecting the charset or
...
public class CharsetDetector {
	 ...
	 * 
	 * @param str the input text of unknown encoding
	 * 
	 ...
	 * @return This CharsetDetector
	 * 
	 * @throws IOException raised in case of an issue
	 */
	 ...
	 *        
	 * @return a Reader to access the converted input
	 */
	 ...
	 * detector.
	 *
	 * @return an array of the names of all charsets that can be recognized by
	 ...
	 * angle brackets ("&lt;" and "glt;") will be removed before detection.
	 * 
	...
	short fByteStats[] = // byte frequency statistics for the input text.
			new short[256]; // Value is percent, not absolute.
							// Value is rounded up, so zero really means zero
							// occurences.

	boolean fC1Bytes = // True if any bytes in the range 0x80 - 0x9F are in the
						// input;
			false;
